...
dir = os.getcwd()
sys.path.append(dir)
from tools import hpi_verfication_randomized
...
if __name__ == '__main__':
    ...
    for index, file in enumerate(all_files):
        ...
        hpiverfication = hpi_verfication_randomized.HPIVerification_Randomized(
            n_iter_opt=30,
            X=X,
            y=y,
        ...
        hp_trials_dict = hpiverfication.randomized_opt_run()
